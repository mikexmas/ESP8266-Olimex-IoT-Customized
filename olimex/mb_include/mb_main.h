/* This is base include file for additional code to Olimex IoT project: put it in user_main.c at last position of inncludes */
	...
	#define MB_AIN_ENABLE		1		// ADC (more advanced than original ADC)
...
//	#define MB_REQTYPE_SPECIAL	9
	#define MB_REQTYPE_THINGSPEAK	3	// special POST (IFTTT when condistion meeet)
	#define MB_REQTYPE_IFTTT	4	// special POST (IFTTT when condistion meeet)
